...
```{r example, fig.width = 4*3.6, fig.height = 2.5*3.6, dpi = 72, dev.args = list(type = "cairo-png")}
library(glyptodon)
library(ggplot2)
library(sysfonts)
library(showtextdb)
...
```{r facets, fig.width = 4*3.6, fig.height = 2*3.6, dpi = 72, dev.args = list(type = "cairo-png")}
